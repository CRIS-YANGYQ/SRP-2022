...
public class MainActivity extends AppCompatActivity {
    ...
    private float magnx = 0;
    private float magny = 0;
    private float magnz = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(view -> {
            if (vibrating) {
                ...
                CheckBox cb1 = (CheckBox) findViewById(R.id.cb_novib);
                if (cb1.isChecked()){
                    writerOpen();
                } else {
        ...
        sensorManager.registerListener(sensorListener, sensora, SensorManager.SENSOR_DELAY_FASTEST);
        sensorManager.registerListener(sensorListener, sensorg, SensorManager.SENSOR_DELAY_FASTEST);
        sensorManager.registerListener(sensorListener, sensorm, SensorManager.SENSOR_DELAY_FASTEST);
    }
...
//        }, time);
    ...
    public void writerOpen(){
        ...
        try {
            ...
            writer.write("row,time,accx,accy,accz,gyrox,gyroy,gyroz,magnx,magny,magnz\n".getBytes());  // time(hour_minute_second_millisecond)
        } catch (IOException e) {
